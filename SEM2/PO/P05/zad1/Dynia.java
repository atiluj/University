...
public class Dynia implements Swierzaki{
    String imie;
    int atrakcyjnosc;
    int naklad;
    String uprawa = "krzak";
    ...
    Dynia(String imie, int atrakcyjnosc, int naklad) //konstruktor
    {
        this.imie = imie;
    ...
    public String toString(){
        ...
        if(owoc == true)
        {
            result = "Dynia " + imie + " " + atrakcyjnosc + " owoc " +"\n";
        }
        else result = "Dynia " + imie + " " + atrakcyjnosc + " warzywo " + "\n";
        return result;
    }
